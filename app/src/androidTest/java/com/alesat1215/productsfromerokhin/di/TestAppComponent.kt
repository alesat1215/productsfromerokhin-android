...
@Singleton
@Component(modules = [AndroidSupportInjectionModule::class, ActivityModule::class, LoadModule::class, StartModule::class, MenuModule::class, CartModule::class, TestRepositoryModule::class])
